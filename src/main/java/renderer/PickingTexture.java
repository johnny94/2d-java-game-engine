...
public class PickingTexture {
    ...
    private boolean init(int width, int height) {
        ...
        // Create the texture object for the depth buffer (We will not use this in 2d game)
        glEnable(GL_TEXTURE_2D); // Seems this should be GL_DEPTH_TEST?
    ...
    public float[] readPixels(Vector2i start, Vector2i end) {
        ...
        Vector2i size = new Vector2i(start).sub(end).absolute();
